...
public class MonitorService {
    ...
    public long create(MonitorDto monitorDto) {

        MonitorEntity monitorEntity = new MonitorEntity();
        monitorEntity.setCount(monitorDto.getCount());
        monitorEntity.setPrice(monitorDto.getPrice());
        monitorEntity.setMadeBy(monitorDto.getMadeBy());
        monitorEntity.setSerial(monitorDto.getSerial());
        monitorEntity.setDiagonal(monitorDto.getDiagonal());
