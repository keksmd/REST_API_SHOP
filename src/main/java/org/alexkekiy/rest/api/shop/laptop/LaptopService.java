...
public class LaptopService {
    ...
    public long create(LaptopDto laptopDto) {

        LaptopEntity laptopEntity = new LaptopEntity();
        laptopEntity.setCount(laptopDto.getCount());
        laptopEntity.setPrice(laptopDto.getPrice());
        laptopEntity.setMadeBy(laptopDto.getMadeBy());
        laptopEntity.setSerial(laptopDto.getSerial());
        laptopEntity.setSize(laptopDto.getSize());
        laptopRepository.save(laptopEntity);
        return laptopEntity.getId();
    }
